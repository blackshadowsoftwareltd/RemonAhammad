...
class PortraitSkyBackground extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    double top=value!<150?0:value!-150,right=value!<150?0:value!-150;
    return Container(
      height: 505,
      ...
      child: Stack(
        children: [
          ...
          /// moon
          Positioned(
              top: top*.4 + 40, right:right*.5+ 80, child: moon()),
          /// bird
          Positioned(
              top: value! * .20 + 100, left: value! * .9, child: birdRight()),
          /// f22
          Positioned(
              top:  150-value!*.45, right: 10+value!, child: f22(15+value!*.2)),
          Positioned(
          ...
          /// tree
          Positioned(
              top: -value! * .40 + 190, right: 20, child: tree1()),
          ...
          Positioned(
              top: -value! * .98 + 420,
              left: -value! * .5 - 10,
              child: verySmallTreeR()),
          Positioned(
              top: -value! * .92 + 410, right: 100, child: verySmallTreeR()),
          Positioned(
              top: -value! * .98 + 460,
              right: -value! * .5 - 10,
              child: grass1()),
